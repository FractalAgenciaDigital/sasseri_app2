...
<html>
    ...
    <title>Reporte de Cilindros</title>
    <style>
        body {
            /*position: relative;*/
            /*width: 16cm;  */
            ...
            <header>
                ...
                <table class="table table-bordered  table-sm">
                    <tr style="    background-color: white;">
                        <td td="14%" rowspan="3">
                            <img src="http://localhost:8000/img/logo2.png" alt="incanatoIT" id="imagen2">
                        </td>
                        <td rowspan="3">
                            <center>
                                <b><h3>{{ $datos['datos_empresa']->nom_compania }}</h3> </b>
                                <span><b>{{ $datos['datos_empresa']->tipo_id }} : {{ $datos['datos_empresa']->identificacion }}</b><br>
                                <b>{{ $datos['datos_empresa']->direccion }}</b><br>
                                <b>{{ $datos['datos_empresa']->ciudad }} - {{ $datos['datos_empresa']->departamento }}</b><br>
                                <b>{{ $datos['datos_empresa']->telefono }}</b>
                            </center>
                        </td>
                ...
                <table class="table table-bordered  table-sm">
                    <tr><td colspan="100%"><b><center>CONTROL DE CALIDAD DEL CONCRETO ESTRUCTURAL</center></b></td></tr>
                    <tr>
