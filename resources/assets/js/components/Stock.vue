                            ...
                            <tbody v-if="permisosUser.leer && arrayStock.length">
                                <tr v-for="stock in arrayStock" :key="stock.id">
                                    <!-- <td>
                                        ...
                                        <template v-if="stock.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarCategoria(stock.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarCategoria(stock.id)">
                                                <i class="icon-check"></i>
                                            </button>
                                        </template>
                                    </td> -->
                                    <td v-text="stock.nombre_producto"></td>
...
<script>
    export default {
        ...
        methods : {
            listarStock (page,buscar,criterio){
                let me=this;
                var url= this.ruta +'/stock?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
        ...
        mounted() {
            this.listarStock(1,this.buscar,this.criterio);
        }
    }
</script>
<style>    
