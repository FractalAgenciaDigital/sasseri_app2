            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Cuentas Por Cobrar
                        <button v-if="permisosUser.crear" type="button" @click="abrirModal('cuentasxcobrar','registrar')" class="btn btn-primary">
                        ...
                        <div>
                            <table class="table table-bordered table-striped table-sm  table-responsive table-earning">
                                ...
                                <tbody v-if="permisosUser.leer">
                                    <tr v-for="(cuentasxcobrar, index) in arrayCuentasxCobrar" :key="index">
                                        <td>{{index+1}}</td>
                                        <td :value="cuentasxcobrar.id_tercero" >
                                        <span v-if="cuentasxcobrar.num_documento!=null" v-text="cuentasxcobrar.num_documento + ' - '"></span>
                                        <span v-if="cuentasxcobrar.nombre1!=null" v-text="cuentasxcobrar.nombre1"></span>
                                        <span v-if="cuentasxcobrar.nombre2!=null" v-text="cuentasxcobrar.nombre2"></span>
                                        <span v-if="cuentasxcobrar.apellido1!=null" v-text="cuentasxcobrar.apellido1"></span>
                                        <span v-if="cuentasxcobrar.apellido2" v-text="cuentasxcobrar.apellido2"></span>
                                        </td>
                                        <td v-text="cuentasxcobrar.fecha_cobro"></td>
                                        <td :value="cuentasxcobrar.id_factura" v-text="cuentasxcobrar.num_factura"></td>
                                        <td style="text-align: right" v-text="cuentasxcobrar.valor_deuda_moneda"></td>
                                        <td style="text-align: right" :value="cuentasxcobrar.id" v-text="cuentasxcobrar.abono_moneda"></td>
                                        <td style="text-align: right" v-text="cuentasxcobrar.saldo_moneda"></td>
                                        <td>
                                            <template v-if="cuentasxcobrar.estado_cobro==1">
                                                <span class="badge badge-warning">
                                                    Pendiente
                                                </span>
                                            </template>
                                            <template v-if="cuentasxcobrar.estado_cobro==2">
                                                <span class="badge badge-danger">
                                                    Cancelados
                                                </span>
                                            </template>
                                            <template v-if="cuentasxcobrar.estado_cobro==3">
                                        ...
                                        <td>   
                                            <template>
                                            <button v-if="cuentasxcobrar.estado_cobro!=2 && cuentasxcobrar.saldo!=0" type="button" @click="abrirModal('cuentasxcobrar','abono',cuentasxcobrar)" class="btn btn-success btn-sm">Abonar</button>
                                            <button v-else type="button"  class="btn btn-secondary btn-sm">Abonar</button>
                                            &nbsp;
                                            </template>
                                            <button v-if="permisosUser.actualizar && cuentasxcobrar.estado_cobro!=2 && cuentasxcobrar.sin_factura==1 && cuentasxcobrar.saldo!=0 && cuentasxcobrar.num_pago==1" type="button" @click="abrirModal('cuentasxcobrar','actualizar',cuentasxcobrar)" class="btn btn-warning btn-sm">
                                           ...
                                           <template v-if="permisosUser.anular">
                                                <button v-if="cuentasxcobrar.estado_cobro!=2 " type="button" class="btn btn-danger btn-sm" @click="desactivarCuentasxCobrar(cuentasxcobrar.id)">
                                                    <i class="icon-trash"></i>
                                                </button>
                                                <button v-else type="button" class="btn btn-info btn-sm" @click="activarCuentasxCobrar(cuentasxcobrar.id)">
                                                    <i class="icon-check"></i>
                                                </button>
                                            </template>
                                            <template v-else>
                                                <button v-if="cuentasxcobrar.estado" type="button" class="btn btn-secondary btn-sm">
                                                    <i class="icon-trash"></i>
                                                </button>
                                                <button v-else type="button" class="btn btn-secondary btn-sm">
                                                    <i class="icon-check"></i>
                                    ...
                                    <tr>
                                        <td colspan="4" style="text-align:right"><b>Total</b></td><td style="text-align:right" v-text="sumaValor"></td><td style="text-align:right" v-text="sumaAbono"></td><td style="text-align:right" v-text="sumaSaldo"></td>
                                    </tr>                             
                                </tbody>
            ...
            <div class="modal fade" tabindex="-1" :class="{'mostrar' : modal}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content modal-width">
                        ...
                        <div v-show="errorCuentasxCobrar" class="form-group row div-error">
                            <div class="text-center text-error">
                                <div v-for="error in errorMostrarMsjCuentasxCobrar" :key="error" v-text="error">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1 " class="btn btn-success" @click="registrarCuentasxCobrar()">Guardar</button>
                            <button type="button" v-if="tipoAccion==2" class="btn btn-success" @click="actualizarCuentasxCobrar()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
                            ...
                            <table class="table table-bordered table-striped table-sm  table-responsive table-earning">
                                ...
                                <tbody>
                                    <tr v-for="(abonos, index) in arrayAbono" :key="index">
                                        ...
                                        <td style="text-align: right" v-text="abonos.fecha_cobro"></td>
                                        <td>
    ...
    export default {
        ...
        data (){
            return {
                ...
                tituloModal : '',
                tipoAccion : 0,
                errorCuentasxCobrar : 0,
                errorMostrarMsjCuentasxCobrar : [],
        ...
        methods : {
            ...
            //Fin modal terceros
            listarCuentasxCobrar(tercero_id_filtro,Bfactura,Bdesde,Bhasta,Bestado){
                let me=this;
                var url= this.ruta +'/cuentasxcobrar?tercero_id_filtro='+ tercero_id_filtro + '&Bfactura='+ Bfactura + '&Bdesde=' + Bdesde + '&Bhasta=' + Bhasta + '&Bestado=' + Bestado;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayCuentasxCobrar = respuesta.cuentas;
            ...
            registrarCuentasxCobrar(){
                this.campo_obligatorio_form= true;
                if (this.validarCuentasxCobrar()){
                    return;
                }
                this.tipoAccion=2;
                let me = this;

                axios.post(this.ruta +'/cuentasxcobrar/registrar',{
            ...
            listarAbonos(id_pago){
                ...
                let me=this;
                var url= this.ruta +'/cuentasxcobrar/saldo?id=' + id_pago;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
            ...
            registrarAbono(){
                ...
                axios.put(this.ruta +'/cuentasxcobrar/registrarAbono',{
            ...
            actualizarCuentasxCobrar(){
               ...
               if (this.validarCuentasxCobrar()){
                ...
                axios.put(this.ruta +'/cuentasxcobrar/actualizar',{
                    'abonoPago': this.abonoPago,
                    'id_pago': this.id_pago,
                    'saldo':this.saldo,
                    'id_tercero': this.tercero_id,
            ...
            desactivarCuentasxCobrar(id){
               Swal.fire({
                title: 'Esta seguro de desactivar esta cuenta por cobrar?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/cuentasxcobrar/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCuentasxCobrar('','','','','');
                        Swal.fire(
            ...
            activarCuentasxCobrar(id){
               Swal.fire({
                title: 'Esta seguro de activar esta cuenta por cobrar?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/cuentasxcobrar/activar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCuentasxCobrar('','','','','');
                        Swal.fire(
               ...
               Swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/cuentasxcobrar/desactivarAbono',{
                        'id': id
                    }).then(function (response) {
        ...
        mounted() {
            ...
            this.Bestado = "1";
            this.listarCuentasxCobrar(this.tercero_id_filtro,this.Bfactura,this.Bdesde,this.Bhasta,this.Bestado);
        }
    }
</script>
<style>    
