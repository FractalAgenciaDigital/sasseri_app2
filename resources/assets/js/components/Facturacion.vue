        ...
        <section class="col-12">
          <div class="card p-0">
            ...
            <div class="card-body" style="margin:auto;">
              <table
                class="table table-bordered table-striped table-responsive table-earning "
              >
                <thead>
                  <tr>
                ...
                <tbody v-if="permisosUser.leer && arrayPendientes.length">
                  <tr
                    v-for="pendientes in arrayPendientes"
                    :key="pendientes.id"
                  ...
                  >
                    ...
                    <td
                      v-if="pendientes.num_factura"
                      v-text="pendientes.num_factura"
                    ></td>
                    <td v-else class="text-left">
                      <button
                        type="button"
                        @click="abrirModalImpresion(pendientes.id)"
                      ...
                      <!-- boton eliminar -->
                      <template
                        v-if="permisosUser.anular && pendientes.estado == 1"
                      >
                        <button
                          type="button"
                          class="btn btn-primary text-white"
                          @click="
                            cambiarEstadoFacturacion(pendientes.id, 'anular')
                          "
                          v-if="
                            pendientes.estado != 4 && pendientes.estado != 3
                          "
                          title="Anular"
                        >
                    ...
                    <td>
                      ...
                      <template>
                        <button
                          type="button"
                          v-if="
                            permisosUser.actualizar && pendientes.estado == 1
                          "
                          class="btn btn-primary text-white"
                          @click="
                            validarRegreso(pendientes.id, pendientes.total)
                          "
                          title="Registrar"
                        >
                        ...
                        <button
                          type="button"
                          v-else-if="
                            permisosUser.actualizar && pendientes.estado == 2
                          "
                          @click="pdfFormato(pendientes.id)"
          ...
          <div class="modal-content">
              ...
              <div class="row border">
                <div class="col-4">
                  <input
                    ...
                    @click="valorEfectivo = 1000"
                    :value="1000"
                  />
                  <input
                    class="btn btn-primary btn-block"
                    @click="valorEfectivo = 2000"
                    :value="2000"
                  />
                  <input
                    class="btn btn-primary btn-block"
                    @click="valorEfectivo = 5000"
                    :value="5000"
                  />
                  <input
                    class="btn btn-primary btn-block"
                    @click="valorEfectivo = 10000"
                    :value="10000"
                  />
                  <input
                    class="btn btn-primary btn-block"
                    @click="valorEfectivo = 20000"
                    :value="20000"
                  />
                  <input
                    class="btn btn-primary btn-block"
                    @click="valorEfectivo = 50000"
                    :value="50000"
                  />
                  <input
                    class="btn btn-primary btn-block"
                    @click="valorEfectivo = 100000"
                    :value="100000"
                  />
                </div>
                <div class="col-8 row">
                  <button class="btn btn-light col-4" @click="append(1)">
                    1
                  </button>
                  <button class="btn btn-light col-4" @click="append(2)">
                    2
                  </button>
                  <button class="btn btn-light col-4" @click="append(3)">
                    3
                  </button>
                  <button class="btn btn-light col-4" @click="append(4)">
                    4
                  </button>

                  <button class="btn btn-light col-4" @click="append(5)">
                    5
                  </button>
                  <button class="btn btn-light col-4" @click="append(6)">
                    6
                  </button>
                  <button class="btn btn-light col-4" @click="append(7)">
                    7
                  </button>
                  <button class="btn btn-light col-4" @click="append(8)">
                    8
                  </button>

                  <button class="btn btn-light col-4" @click="append(9)">
                    9
                  </button>
                  <button
                    class="btn btn-danger col-4"
                    @click="limpiarRegreso()"
                  >
                    x
                  </button>
                  <button class="btn btn-light col-4" @click="append(0)">
                    0
                  </button>
                  <button
                    type="button"
                    class="btn btn-success col-4"
                    @click="calcularRegreso()"
                  >
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                @click="opcionPago(facturacion_id)"
              >
                Pagar
              </button>
              <button
                type="button"
                class="btn btn-primary"
                @click="opcionPagoImprimir(facturacion_id)"
              >
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button
                type="button"
                class="btn btn-success"
                @click="imprimirTicketFacturacion()"
              >
                Imprimir
              </button>
            </div>
...
export default {
  ...
  methods: {
        ...
        if (result.value) {
          ...
          if (accion == "registrar") {
            axios
              .get(
                this.ruta +
                  "/facturacion/imprimir-ticket-facturacion?id=" +
                  this.facturacion_id +
                  "&id_impresora=1&valorEfectivo=" +
                  this.valorEfectivo +
                  "&valorCambio=" +
                  this.valorRegreso
              )
    ...
    opcionPago(id_factura, accion) {
      ...
      axios
        .get(this.ruta + "/facturacion/abrir-caja-registradora?&id_impresora=1")
        .then(function(response) {
          me.modalRegreso = 0;
          me.listarPendientes();
        })
