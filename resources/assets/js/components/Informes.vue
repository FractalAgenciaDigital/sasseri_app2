<template>
  <main class="main">
        ...
        <template v-if="listado == 1">
          <div class="card-body">
              ...
              <!--<div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-inline float-right">
                                        ...
                                        <button v-if="permisosUser.leer" @click="quitar(4)" style="min-width: 30px;" class="btn btn-danger form-control">
                                            <i class="icon-trash"></i>
                                        </button>
                                        <button v-else style="min-width: 30px;" class="btn btn-secondary form-control">
                                            <i class="icon-trash"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-inline float-right">
                                        ...
                                        <button v-if="permisosUser.leer" @click="quitar(5)" style="min-width: 30px;" class="btn btn-danger form-control">
                                            <i class="icon-trash"></i>
                                        </button>
                                        <button v-else style="min-width: 30px;" class="btn btn-secondary form-control">
                                            <i class="icon-trash"></i>
                ...
                <div class="col-md-3">
                  ...
                  <div class="float-right col-md-10">
                    ...
                    >
                      ...
                      <option
                        v-for="(cajas, index) in arrayCajas"
                        :key="index"
                        :value="cajas.id"
                        v-text="cajas.nombre"
                      ></option>
            ...
            <div
              ...
              style="overflow-y: auto;max-height: 26em !important;display: block;border: none;"
            >
              <table
              ...
              >
                ...
                <tbody v-if="permisosUser.leer && arrayFacturacion.length">
                  <tr
                    v-for="facturacion in arrayFacturacion"
                    :key="facturacion.id"
                  ...
                  >
                    ...
                    <td v-if="facturacion.num_factura">
                      <a
                        v-text="facturacion.num_factura"
                        href="#"
                        @click="excelFormato(facturacion.id)"
                      ></a>
                    </td>
                    <td v-else>
                      <a href="#" @click="excelFormato(facturacion.id)"
                        ><i class="icon-eye"></i
                      ></a>
                    </td>
                    ...
                    <td v-else-if="facturacion.estado == 2">
                      <span>Registrada</span>
                    </td>
                    <td v-else-if="facturacion.estado == 3">
                      <span>Enviada</span>
                    </td>
                    <td v-else-if="facturacion.estado == 4">
                      <span>Anulada</span>
                    </td>
                    <!--<td>
          ...
          <div class="card-body">
            <div class="form-group row border">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <select
                    v-model="id_tarifario"
                    class="form-control"
                    @change="cargarPreciosTarifarios(id_tarifario)"
                  >
                    <option
                      v-for="tarifario in arrayTarifario"
                      :key="tarifario.id"
                      :value="tarifario.id"
                      v-text="tarifario.nombre"
                    ></option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-3" v-if="estado" style="display:none;">
                <div class="form-group">
                  ...
                  >
                    <option value="1" v-if="estado == 1" disabled selected
                      >Creada</option
                    >
                    <option value="2">Registrada</option>
                    <option value="3">Enviada</option>
            ...
            <div class="form-group row border">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label
                    ...
                    <span
                      style="color:red;"
                      v-show="cantidad == 0 && idarticulo != 0"
                      >(*Ingrese)</span
                    ></label
                  >
                  ...
                  <span
                    v-if="stock != 0"
                    v-text="'Cantidad en stock: ' + stock"
                  ></span>
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input
                    ...
                    v-if="idarticulo != 0"
                    :min="0"
                    :max="Math.round((precio * cantidad) / (iva / 100 + 1))"
                    @blur="
                      if (
                        descuento >
                        Math.round((precio * cantidad) / (iva / 100 + 1))
                      )
                        descuento = Math.round(
                          (precio * cantidad) / (iva / 100 + 1)
                        );
                    "
                    class="form-control"
                    v-model="descuento"
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <button
                    v-else
                    class="btn btn-secondary form-control btnagregar"
                  >
                    <i class="icon-plus"></i>
                  </button>
                </div>
                ...
                >
                  ...
                  <tbody v-if="arrayDetalle.length">
                    ...
                    >
                      ...
                      <td
                        v-text="
                          detalle.articulo + ' - ' + detalle.nom_presentacion
                        "
                      ></td>
                      ...
                      <td style="text-align: right;">
                        ...
                        {{
                          (detalle.valor_iva = Math.round(
                            parseFloat(detalle.precio * detalle.cantidad) -
                              parseFloat(
                                (detalle.precio * detalle.cantidad) /
                                  (detalle.iva / 100 + 1)
                              )
                      ...
                      <td style="text-align: right;">
                        $
                        {{
                          (detalle.valor_subtotal = Math.round(
                            parseFloat(
                              detalle.precio * detalle.cantidad -
                                detalle.valor_iva -
                                detalle.valor_descuento
            ...
            <div v-show="errorFacturacion" class="form-group row div-error">
              <div class="text-center text-error">
                <div
                  v-for="error in errorMostrarMsjFacturacion"
                  :key="error"
                  v-text="error"
                ></div>
              </div>
            ...
            <div class="form-group row" v-if="tipoAccion2 == 2">
              <div class="col-md-12">
                ...
                <button
                  ...
                  v-if="estado == 1"
                  class="btn btn-primary"
                  @click="cambiarEstadoFacturacion(facturacion_id, 'registrar')"
                >
                  Registrar
                </button>
              </div>
        ...
        <template v-else-if="listado == 2">
          <div class="card-body">
            <div class="form-group row border">
              ...
              <div class="col-md-2">
                <label
                  v-text="'N° factura: ' + num_factura"
                  v-if="num_factura != null"
                ></label>
              ...
              <div class="col-md-2">
                <label
                  v-text="'Estado: Activa'"
                  class="btn-warning"
                  v-if="estado == 1"
                  style="font-size: 100%;"
                ></label>
                <label
                  v-text="'Estado: Registrada'"
                  class="btn-success"
                  v-else-if="estado == 2"
                  style="font-size: 100%;"
                ></label>
                <label
                  v-text="'Estado: Enviada'"
                  class="btn-primary"
                  v-else-if="estado == 3"
                  style="font-size: 100%;"
                ></label>
                <label
                  v-text="'Estado: Anulada'"
                  class="btn-danger"
                  v-else-if="estado == 4"
                  style="font-size: 100%;"
                ></label>
          ...
          <div class="modal-body">
            <div class="form-group row">
              <div class="col-sm-12 col-md-5 pb-sm-1">
                <label class="control-label col-sm-3 col-md-4 float-left"
                  ><i class="fa fa-search"></i> Buscar</label
                >
                <input
                  type="text"
                  v-model="buscarA"
                  @keyup="listarArticulo(buscarA, criterioA, buscarCategoriaA)"
                  class="form-control col-sm-9 col-md-8 float-right"
                  placeholder="Texto a buscar"
                />
              </div>
              <div class="col-sm-9 col-md-5">
                <label class="control-label col-sm-4 col-md-4 float-left"
                  ><i class="fa fa-search"></i> Categoría</label
                >
                <select
                  class="form-control col-sm-8 col-md-8 float-right"
                  v-model="buscarCategoriaA"
                  @change="listarArticulo(buscarA, criterioA, buscarCategoriaA)"
                >
                  <option value="">Seleccione</option>
                  <option
                    v-for="categoria in arrayCategoria2"
                    :key="categoria.id"
                    :value="categoria.id"
              ...
              <div class="col-sm-3 col-md-2 text-center">
                ...
                <button
                  ...
                  type="button"
                  class="btn btn-secondary"
                  @click="tipo_vista_articulo = 1"
                >
                  <i class="fa fa-list"></i>
                </button>
                <button
                  v-if="tipo_vista_articulo == 2"
                  type="button"
                  class="btn btn-info"
                >
            ...
            <div
              v-if="tipo_vista_articulo == 1"
              class="table-responsive"
              style="display: block;height: 35em;max-height: 35em;overflow-y: auto;"
            >
              <table
                class="table table-bordered table-striped table-sm  table-responsive"
              >
                ...
                <tbody>
                  <tr v-for="(articulo, index) in arrayArticulo" :key="index">
                    <td
                      v-if="articulo.padre == ''"
                      v-text="articulo.codigo"
                    ></td>
                    <td v-else></td>
                    <td>
                      <img
                        v-if="`${articulo.img}` != 'default.png'"
                        :src="
                          `${ruta}/img_productos/${articulo.id_empresa}_empresa/${articulo.img}`
                        "
                        height="30"
                        width="30"
                      />
                      ...
                      <img
                        v-else
                        :src="`${ruta}/img_productos/${articulo.img}`"
                        height="30"
                        width="30"
                      />
                    </td>
                    <td>
                      ...
                      <span
                        v-if="articulo.id_presentacion != null"
                        v-text="' - ' + articulo.nom_presentacion"
                      ></span>
                      <span v-else> - N/A presentacion</span>
                      <span
                        v-if="articulo.talla != null"
                        v-text="' - ' + articulo.talla"
                      ></span>
                    ...
                    <td
                      v-if="articulo.padre != ''"
                      v-text="parseInt(articulo.stock / articulo.unidades)"
                    ></td>
                    ...
                    <td v-if="articulo.cant">
                      <button
                        type="button"
                        v-if="articulo.cant != 0 && articulo.cant != ''"
                        @click="
                          agregarDetalleModal(articulo), (articulo.cant = '')
                        "
            ...
            <div
              v-if="tipo_vista_articulo == 2"
              class="container"
              style="display: block;height: 36em;max-height: 36em;overflow-y: auto;"
            >
              <div
                v-for="(articulo, index) in arrayArticulo"
                :key="index"
                @click="abrirModalCantidadArticulo(articulo)"
                class="col-sm-6 col-md-3 p-sm-2 p-md-1 mosaico"
                style="height: 43%;"
              >
    ...
    <div
      class="modal fade"
      tabindex="-1"
      :class="{ mostrar: modalCantidadArticulo }"
      role="dialog"
      aria-labelledby="myModalLabel"
      style="display: none;"
      aria-hidden="true"
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button
              type="button"
              class="close"
              @click="cerrarModalCantidadArticulo()"
              aria-label="Close"
            >
              <span aria-hidden="true">×</span>
            </button>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 pb-sm-2 pb-md-1">
                  <div class="col-sm-10 col-md-10 float-left">
                    ...
                    <input
                      type="number"
                      class="form-control float-right col-sm-9 col-md-8"
                      v-model="cantidadArticulo"
                    />
                  </div>
                  <div class="col-sm-2 col-md-2 float-right">
                    <button
                      v-if="cantidadArticulo != 0 && cantidadArticulo != ''"
                      type="button"
                      @click="agregarDetalleModalCantidadArticulo()"
                ...
                <div class="col-sm-12 col-md-12">
                  <div class="col-sm-4 col-md-5 float-right">
                    <label class="col-sm-6 col-md-6 float-left"
                      >Saldo parcial</label
                    >
                    <label
                      class="col-sm-6 col-md-6 float-right"
                      v-text="precioArticulo"
                    ></label>
                  </div>
            ...
            <div class="table-responsive">
              ...
              >
                ...
                <tr v-for="tercero in arrayTerceros" :key="tercero.id">
                  ...
                  <td v-if="tercero.nombre && !tercero.nombre1">
                    {{ tercero.nombre }}
                  </td>
                  <td v-else>
                    {{
                      tercero.nombre1 +
                        " " +
                        validarUnder(tercero.nombre2) +
                        " " +
                        tercero.apellido1 +
                        " " +
                        validarUnder(tercero.apellido2)
                    }}
                  </td>
                  <td>
                    <button
    ...
    >
      <div class="modal-dialog modal-primary modal-lg" role="document">
        <div class="modal-content">
          ...
          <div
            v-if="tipoAccionCierre != 3 && tipoAccionCierre != 4"
            class="modal-body"
          >
            <div class="form-group row">
              <div class="col-md-12">
                ...
                <div class="float-right col-md-11">
                  <select
                    v-if="tipoAccionCierre == 2"
                    disabled
                    class="form-control float-right"
                    v-model="id_caja_cierre"
                  >
                    <option></option>
                    <option
                      v-for="(caja, index) in arrayCajas"
                      :key="index"
                      :value="caja.id"
                      v-text="caja.nombre"
                    ></option>
                  ...
                  <select
                    ...
                    class="form-control float-right"
                    v-model="id_caja_cierre"
                    @change="selectValorInicialCaja(id_caja_cierre)"
                  >
                    <option></option>
                    <option
                      v-for="(caja, index) in arrayCajas"
            ...
            <div v-if="tipoAccionCierre == 3" class="row container">
              ...
              >
                ...
                <tbody v-if="permisosUser.leer && arrayCierresUsuario.length">
                  <tr
                    v-for="cierre_caja in arrayCierresUsuario"
                    :key="cierre_caja.id"
                  >
                    ...
                    <td>
                      <button
                        v-if="permisosUser.leer"
                        type="button"
                        @click="
                          mostrarDetalle('cierres_caja', 'ver', cierre_caja)
                        "
                      ...
                      <template v-if="permisosUser.anular">
                        <button
                          ...
                          type="button"
                          class="btn btn-danger btn-sm"
                          @click="desactivarCierreXCaja(cierre_caja.id)"
                        >
                          <i class="icon-trash"></i>
                        </button>
                        <button
              ...
              <div class="col-md-12">
                <div class="col-md-6 float-left">
                  <div class="col-md-12">
                    <label
                      ...
                      v-text="'Valor inicial: ' + vr_inicial_cierre"
                    ></label>
                  </div>
                  <div class="col-md-12">
                    <label class="col-md-3 float-left"
                      >Observacion inicial:</label
                    >
                    <div class="col-md-9 float-right">
                      <p
                        v-text="obs_inicial_cierre"
                        class="col-md-12 float-left"
                        style="overflow-y: auto;max-height: 8em;"
                      ></p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 float-right">
                  <div class="col-md-12">
                    <label
                      class="col-md-12 float-left"
                      v-text="'Valor inicial: ' + vr_gastos_cierre"
                    ></label>
                  </div>
                  <div class="col-md-12">
                    <label class="col-md-3 float-left"
              ...
              <div class="col-md-12">
                <div class="col-md-12">
                  <div class="col-md-12">
                    <label
                      class="col-md-12 float-left"
                      v-text="'Valor final: ' + vr_final_cierre"
                    ></label>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-footer">
            ...
            <button
              type="button"
              v-if="tipoAccionCierre == 1"
              class="btn btn-primary"
              @click="registrarCierreXCaja()"
            >
              Guardar
            </button>
            <button
              ...
              v-if="tipoAccionCierre == 2"
              class="btn btn-primary"
              @click="cerrarCierreXCaja(id_cierre_caja_facturacion)"
            >
              Cerrar Caja
            </button>
          </div>
...
export default {
      ...
      for (var i = 0; i < this.arrayDetalle.length; i++) {
        resultado =
          ...
          (this.arrayDetalle[i].precio * this.arrayDetalle[i].cantidad -
            this.arrayDetalle[i].valor_descuento);
      }
  ...
  methods: {
    ...
    listarDetalle(id_factura) {
      ...
      var url =
        this.ruta +
        "/detalle_facturacion/buscarDetalleFacturacion?id_factura=" +
        id_factura;
      axios
        .get(url)
        .then(function(response) {
            ...
            me.arrayCierresXCajas.forEach(function(cierre) {
              if (cierre["usu_crea"] == respuesta.id_usuario) {
                ...
                if (cierre["estado"] == 1) {
                  ...
                  var n1 = cierre["created_at"].split(" ");
                  var n2 = n1[0].split("-");
                  var n3 = n1[1].split(":");
                  ...
                  if (yyyy == n2[0]) {
                    ...
                    me.mostrarDetalle("cierres_caja", "listar_cierres", cierre);
                  }
                }
              }
            });
    ...
    registrarCierreXCaja() {
      ...
      axios
        .post(this.ruta + "/cierres_caja/registrar", {
    ...
    actualizarCierreXCaja() {
      ...
      axios
        .put(this.ruta + "/cierres_caja/actualizar", {
          id_caja: this.id_caja_cierre,
          vr_inicial: this.vr_inicial_cierre,
          obs_inicial: this.obs_inicial_cierre,
          vr_gastos: this.vr_gastos_cierre,
    ...
    desactivarCierreXCaja(id) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios
            .put(this.ruta + "/cierre_caja/desactivar", {
              id: id,
            })
            .then(function(response) {
    ...
    activarConcentracion(id) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios
            .put(this.ruta + "/concentracion/activar", {
              id: id,
            })
            .then(function(response) {
              me.listarCajas(1, "", "nombre");
    ...
    cerrarCierreXCaja(id) {
      ...
      if (
        me.id_caja != "" &&
        me.vr_inicial_cierre != 0 &&
        me.vr_final_cierre != 0 &&
        me.vr_gastos_cierre != 0
      ) {
        Swal.fire({
          ...
          if (result.value) {
            ...
            axios
              .put(this.ruta + "/cierres_caja/cerrar", {
                id_caja: this.id_caja_cierre,
                obs_inicial: this.obs_inicial_cierre,
                vr_gastos: this.vr_gastos_cierre,
                obs_gastos: this.obs_gastos_cierre,
            ...
            if (me.arrayArticulo[0]["productos_asociados"].length > 0) {
              ...
              if (me.arrayArticulo[0]["padre"] != "") {
                p =
                  ...
                  me.arrayArticulo[0]["nom_presentacion"] +
                  ")";
              } else {
                p = " - " + me.arrayArticulo[0]["nom_presentacion"];
              }
              me.articulo =
                me.arrayArticulo[0]["codigo"] +
                " - " +
                me.arrayArticulo[0]["nombre"] +
                p;
              ...
              for (
                var i = 0;
                i < me.arrayArticulo[0]["productos_iva"].length;
                i++
              ) {
                if (
                  me.arrayArticulo[0]["productos_iva"][i]["tipo_iva"] == "Venta"
                ) {
                  me.porcentaje =
                    me.arrayArticulo[0]["productos_iva"][i]["porcentaje"];
                }
              }
    ...
    cambiarEstadoFacturacion(id_factura, accion) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios
            .put(this.ruta + "/facturacion/cambiarEstado", {
    ...
    cargarPreciosTarifarios(id) {
      ...
      if (arrayIds.length) {
        var url =
          this.ruta +
          "/producto_tarifario/cargarPreciosTarifarios?arrayDetalle=" +
          ...
          .then(function(response) {
            ...
            for (var i = 0; i < me.arrayDetalle.length; i++) {
              for (var j = 0; j < respuesta.producto_tarifario.length; j++) {
                if (
                  me.arrayDetalle[i].idarticulo ==
                  respuesta.producto_tarifario[j].id_producto
                ) {
                  me.arrayDetalle[i].precio =
                    respuesta.producto_tarifario[j].valor;
                }
              }
            }
          })
    ...
    agregarDetalleModal(data = []) {
      ...
      if (me.encuentra(data["id"], data["id_asociado"])) {
        ...
        data["productos_iva"].forEach(function(iva) {
          if (iva["tipo_iva"] == "Venta") {
            ivaVenta = iva["porcentaje"];
          }
        });
    ...
    agregarDetalleModalCantidadArticulo() {
      ...
      if (
        me.encuentra(
          me.arrayInfoArticuloModalCantidad.id &&
            me.arrayInfoArticuloModalCantidad.id_asociado
        )
      ) {
        Swal.fire({
          type: "error",
        ...
        if (me.arrayInfoArticuloModalCantidad.padre != "") {
          p =
            " - (Presentacion asociada: " +
            me.arrayInfoArticuloModalCantidad.padre +
            ")";
        } else {
        ...
        me.arrayDetalle.push({
          ...
          articulo:
            me.arrayInfoArticuloModalCantidad.codigo +
            " - " +
            me.arrayInfoArticuloModalCantidad.nombre +
            p,
          porcentaje: ivaVenta,
    ...
    listarArticulo(buscar, criterio, categoria) {
      ...
      if (categoria && categoria != "") {
        var_categoria = "&categoria=" + categoria;
      }
      var url =
        this.ruta +
    ...
    registrarFacturacion() {
      ...
      axios
        .post(this.ruta + "/facturacion/registrar", {
          num_factura: null,
    ...
    actualizarFacturacion() {
      ...
      axios
        .put(this.ruta + "/facturacion/actualizar", {
          num_factura: me.num_factura,
          id_tercero: me.id_tercero,
    ...
    validarFacturacion() {
      ...
      if (this.fecha == 0)
        this.errorMostrarMsjFacturacion.push("Ingrese la fecha");
      // if (this.num_factura==0) this.errorMostrarMsjFacturacion.push("Seleccione el comprobante");
      if (!this.id_tercero)
        this.errorMostrarMsjFacturacion.push("Seleccione un tercero");
      if (!this.lugar)
        this.errorMostrarMsjFacturacion.push("Seleccione un lugar");
      if (this.arrayDetalle.length <= 0)
        this.errorMostrarMsjFacturacion.push("Ingrese detalles");
          ...
          switch (accion) {
            ...
            case "listar_cierres": {
              Swal.fire({
                title: "ERROR!",
                text:
                  "Este usuario tiene una caja abierta desde hace mas de 24 horas",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
    ...
    desactivarIngreso(id) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios
            .put(this.ruta + "/ingreso/desactivar", {
              id: id,
            })
            .then(function(response) {
              me.listarFacturacion(1, "", "", "");
