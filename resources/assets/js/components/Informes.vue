                                ...
                                <div v-for="(articulo, index) in arrayArticulo" :key="index" @click="abrirModalCantidadArticulo(articulo)" class="col-sm-6 col-md-3 p-sm-2 p-md-1 mosaico" style="height: 43%;">
                                    <div class="border col-md-12" style="height: 100%;">
                                        <div class="text-center py-md-2">
                                            <img v-if="`${articulo.img}`!='default.png'" :src="`${ruta}/img_productos/${articulo.id_empresa}_empresa/${articulo.img}`" class="img-responsive img-thumbnail">

                                            <img v-else :src="`${ruta}/img_productos/${articulo.img}`" class="img-responsive img-thumbnail">
                                        </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <div class="float-right col-md-11">
                                        <select v-if="tipoAccionCierre==2" disabled class="form-control float-right" v-model="id_caja_cierre">
                                            <option></option>
                                            <option v-for="(caja, index) in arrayCajas" :key="index" :value="caja.id" v-text="caja.nombre"></option>
                                        </select>
                                        <select v-else class="form-control float-right" v-model="id_caja_cierre" @change="selectValorInicialCaja(id_caja_cierre)">
                                            <option></option>
                                            <option v-for="(caja, index) in arrayCajas" :key="index" :value="caja.id" v-text="caja.nombre"></option>
                                        </select>
                                    </div>
