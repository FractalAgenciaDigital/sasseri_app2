...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            selectDetalleIngreso(id){ 
                let me=this;
                var url= this.ruta +'/detalle_ingreso/selectDetalleIngreso?id='+id;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayDetalle = respuesta.detalle_ingreso;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            agregarDetalleModal(data =[]){
                ...
                if(me.encuentra(data['id'], data['id_presentacion'])){
                    ...
                    data['productos_iva'].forEach(function(iva){
                        if(iva['tipo_iva']=='Compra'){ivaCompra=iva['porcentaje'];}
                    });
            ...
            actualizarIngreso(){
                ...
                axios.put( this.ruta + '/ingreso/actualizar',{
                    'idproveedor': this.id_tercero,
                    'regimen_proveedor' : this.regimen_tercero,
                    'tipo_comprobante': this.tipo_comprobante,
                    'serie_comprobante' : this.serie_comprobante,
            ...
            validarIngreso(){
                ...
                if (this.id_tercero==0 || this.id_tercero=='') this.errorMostrarMsjIngreso.push("Seleccione un Proveedor");
                if (this.tipo_ingreso==0 || this.tipo_ingreso=='') this.errorMostrarMsjIngreso.push("Seleccione el tipo de ingreso");
                if (this.tipo_ingreso=='Compras' && this.forma_pago==0) this.errorMostrarMsjIngreso.push("Seleccione una fuente");
                if (this.fecha_ingreso=='') this.errorMostrarMsjIngreso.push("Ingrese la fecha de ingreso");
                if (this.arrayDetalle.length<=0) this.errorMostrarMsjIngreso.push("Agregue detalles");
            ...
            verIngreso(id){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.regimen_tercero = arrayIngresoT[0]['regimen'];
            ...
            cerrarIngreso(data){
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/ingreso/cerrar',{
                        'tipo_ingreso' : this.tipo_ingreso,
            ...
            abrirModalActualizarIngreso(data=[]){
                this.listado = 0;
                this.tipoAccion=2;
                this.selectFuentes();
                this.selectTipoFormato();
                this.selectDetalleIngreso(data['id']);
                ...
                this.detalle_ingreso = data['detalle'];
